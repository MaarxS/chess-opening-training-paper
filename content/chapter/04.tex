...
\begin{enumerate}
     \item Als erstes wählt der Nutzer den Lernmodus aus. Das Frontend schickt dann eine GET Anfrage an den Endpuntk \lstinline{/openings}. Dieser liefert eine Liste von OpeningOverviews, was Objekte sind, die die Namen und IDs der Wurzeleröffnungen darstellen. Diese Namen werden dem Nutzer zur Auswahl gezeigt.

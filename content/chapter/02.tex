...
Aufschluss über diese Beobachtungen soll die Template Theorie geben, welche von Gobet und Simon in \cite{gobet_templates_1996} beschrieben wird. Die Template Theorie berücksichtigt, dass das kognitive System der Menschen drei Hauptbestandteilen besteht, wie in \autoref{gedächtnis} beschrieben. Ein Unterschied ist, dass das sensorische Gedächtnis räumlichen-zeitlicher Speicher genannt wird. Die anderen beiden Bestandteile, das stark begrenzte Kurzzeitgedächtnis und das Langzeitgedächtnis werden ähnlich betrachtet.
Bei dem Langzeitgedächtnis wird auch zwischen deklarativem und prozeduralem Wissen unterschieden.
